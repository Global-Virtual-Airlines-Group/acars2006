	...
	public void flush(Collection<PositionMessage> entries) throws DAOException {
		try {
			...
			for (Iterator<PositionMessage> i = entries.iterator(); i.hasNext(); ) {
				...
				_ps.setInt(19, msg.getGroundOperations());
				...
				_ps.setInt(26, msg.getTemperature());
				_ps.setInt(27, msg.getPressure());
				_ps.setDouble(28, msg.getVisibility());
				_ps.setDouble(29, msg.getAngleOfAttack());
				_ps.setDouble(30, msg.getG());
				_ps.setInt(31, msg.getFrameRate());
				_ps.setString(32, msg.getNAV1());
				_ps.setString(33, msg.getNAV2());
				_ps.setInt(34, msg.getVASFree());
