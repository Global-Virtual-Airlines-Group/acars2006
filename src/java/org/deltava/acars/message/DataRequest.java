// Copyright 2018, 2019, 2020, 2022, 2025 Global Virtual Airlines Group. All Rights Reserved.
...
public enum DataRequest implements SubRequest {
	...
	FIR("fir"), RUNWAYS("runways"), GATES("gates"), RWYINFO("runwayinfo"), TAXITIME("taxitime"), SBDATA("simBrief"), ATIS("atis"), SBPLAN("simBriefPlan");
