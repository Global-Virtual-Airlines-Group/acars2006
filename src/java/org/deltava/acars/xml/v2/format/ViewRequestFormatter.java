...
/**
 * A formatter for Flight Viewer request messages.
 * @author Luke
 * @version 2.8
 * @since 2.8
 */

public class ViewRequestFormatter extends XMLElementFormatter {
	...
	public Element format(Message msg) {
		...
		initDataResponse(pe, reqmsg.getRequestTypeName());
